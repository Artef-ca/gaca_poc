"""
Sentiment Extraction - Airlines (TripAdvisor reviews).
...
if __name__ == '__main__':
    ...
    system_prompt = get_airline_review_prompt(TAXONOMY_PATH)

    print(f'Loading TripAdvisor reviews: {TRIPADVISOR_PATH}')
    reviews = pd.read_csv(TRIPADVISOR_PATH)
    reviews = reviews[reviews['data_source'].isin(['tripadvisor', 'googleReview'])]
