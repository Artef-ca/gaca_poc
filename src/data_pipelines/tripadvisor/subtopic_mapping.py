"""
Subtopic Mapping - Airlines (TripAdvisor reviews).
...
PP_OUTPUT   = f'airlines_sentiment/intermediate_sentiments/{BATCH_DATE}_batches/painpoints'
MOD_OUTPUT  = f'airlines_sentiment/intermediate_sentiments/{BATCH_DATE}_batches/mods'
...
def _categorise(df, allowed_topics, pains_df, delights_df, batch_size,
    ...
    for topic in allowed_topics:
        ...
        system_prompt = get_subtopic_mapping_prompt('airline', label, subtopics)
        data_list = [
...
if __name__ == '__main__':
    ...
    allowed = taxonomy_df[taxonomy_df['type'] == 'AIRLINE']['topic'].unique().tolist()
    pains, delights = build_subtopic_lists(taxonomy_df, 'AIRLINE')
    ...
    print('Airline subtopic mapping complete.')
